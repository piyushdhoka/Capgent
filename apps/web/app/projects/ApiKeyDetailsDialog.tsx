    ...
    <Dialog>
      ...
      <DialogContent className="sm:max-w-xl p-0 overflow-hidden flex flex-col">
        ...
        <div className="flex-1 flex flex-col gap-6 px-6 pb-8 pt-4">
          <div className="flex flex-col gap-2">
            ...
            <div className="flex items-center justify-between group">
              ...
              <Button variant="ghost" size="icon" className="h-8 w-8 text-muted-foreground hover:text-foreground opacity-60 group-hover:opacity-100" onClick={() => copyToClipboard(apiKey.id, setCopiedKey)}>
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex items-center justify-between group">
              ...
              <Button variant="ghost" size="icon" className="h-8 w-8 text-muted-foreground hover:text-foreground opacity-60 group-hover:opacity-100" onClick={() => copyToClipboard(apiKey.label || "Untitled key", setCopiedName)}>
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex items-center justify-between group">
              ...
              <Button variant="ghost" size="icon" className="h-8 w-8 text-muted-foreground hover:text-foreground opacity-60 group-hover:opacity-100" onClick={() => copyToClipboard(`projects/${apiKey.project.id}`, setCopiedProjectName)}>
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex items-center justify-between group">
              ...
              <Button variant="ghost" size="icon" className="h-8 w-8 text-muted-foreground hover:text-foreground opacity-60 group-hover:opacity-100" onClick={() => copyToClipboard(apiKey.project.id, setCopiedProjectNumber)}>
        ...
        <div className="flex items-center justify-between px-6 py-5 bg-muted/30 border-t border-border/40">
          <Button variant="ghost" className="text-destructive hover:text-destructive/90 px-0 font-medium text-[15px] hover:bg-transparent" onClick={handleDelete}>
            Delete key
          </Button>
